...
class Particle:
    ...
    # generating a z is going to be inventive
    #normal structure of z is r,phi,landmark ID
    #corresponds to angle between robot, distance, and known obstacle
    ...
    #####################################I have completed everything in this list up to here ##########################################################
